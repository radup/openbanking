...
public class BalancesApiServiceImpl extends BalancesApiService {
      @Override
      public Response getBalances(String xFapiFinancialId,String authorization,String xFapiCustomerLastLoggedTime,String xFapiCustomerIpAddress,String xFapiInteractionId,SecurityContext securityContext)
