...
import com.finologee.psd2hub.ob.server.api.factories.DirectDebitsApiServiceFactory;
...
@io.swagger.annotations.Api(description = "the direct-debits API")
...
public class DirectDebitsApi  {
   private final DirectDebitsApiService delegate = DirectDebitsApiServiceFactory.getDirectDebitsApi();

    @GET
    
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get Direct Debits", notes = "Get Direct Debits", response = AccountGETResponse1.class, authorizations = {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "Direct Debits successfully retrieved", response = AccountGETResponse1.class),
