...
@ApiModel(description="Amount of money in the cash entry.")
...
public class AccountTransactionsGETResponseAmount   {
 ...
 @Pattern(regexp="^[A-Z]{3}$")  public String getCurrency() {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AccountTransactionsGETResponseAmount accountTransactionsGETResponseAmount = (AccountTransactionsGETResponseAmount) o;
    return Objects.equals(amount, accountTransactionsGETResponseAmount.amount) &&
        Objects.equals(currency, accountTransactionsGETResponseAmount.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountTransactionsGETResponseAmount {\n");
