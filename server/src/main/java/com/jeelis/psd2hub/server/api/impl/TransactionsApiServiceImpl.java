...
public class TransactionsApiServiceImpl extends TransactionsApiService {
      @Override
      public Response getTransactions(String xFapiFinancialId,String authorization,String xFapiCustomerLastLoggedTime,String xFapiCustomerIpAddress,String xFapiInteractionId,Date fromBookingDateTime,Date toBookingDateTime,SecurityContext securityContext)
