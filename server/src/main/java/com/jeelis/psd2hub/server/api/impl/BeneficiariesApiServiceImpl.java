...
public class BeneficiariesApiServiceImpl extends BeneficiariesApiService {
      @Override
      public Response getBeneficiaries(String xFapiFinancialId,String authorization,String xFapiCustomerLastLoggedTime,String xFapiCustomerIpAddress,String xFapiInteractionId,SecurityContext securityContext)
